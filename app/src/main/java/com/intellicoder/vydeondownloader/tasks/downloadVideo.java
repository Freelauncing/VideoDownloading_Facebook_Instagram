...
import com.intellicoder.vydeondownloader.models.LikeeVideoDownloader;
...
import static com.intellicoder.vydeondownloader.utils.Constants.videoDownloaderFolderName;
...
//            lIkeeVideoDownloader.DownloadVideo();
            ...
            //new DownloadTask(Mcontext).execute(url);
            //CalldlApisDataData(url, true);
...
//            downloader.DownloadVideo();
        ...
        else if (url.contains("snackvideo.com") ||
                url.contains("sck.io")) {
...
//            // getAllDataForLikee2(url, true);
        ...
        else if (url.contains("drive.google.com") || url.contains("mp4upload") ||
...
//                                            }
    ...
    public static class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        String fileN = null ;
        //String videoDownloaderFolderName = "AIO_Video_Downloader"
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                ...
                fileN = "LikeeDownloader_" + UUID.randomUUID().toString().substring(0, 10) + ".mp4";
                File folder;
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    folder = new File(Environment.getExternalStorageDirectory() +
                            File.separator + Constants.videoDownloaderFolderName);
