...
//        val timer:CheckBox = view.findViewById(R.id.test)
//        //timer.isChecked = viewModel.isAlarmOn.value!!
...
//        }
        ...
        ViewModel.isAlarmOn.observe(this.viewLifecycleOwner, androidx.lifecycle.Observer {
            if(it != true){
                clearFB()
            }
        })
...
//           https://www.instagram.com/p/CLBM34Rhxek/?__a=1
        ...
        try {
            ...
            val uri = URI(Url)
            Urlwi = URI(uri.scheme, uri.authority, uri.path,
        ...
        try {
            ...
            val map = sharedPrefsFor.getPreference(SharedPrefsForInstagram.PREFERENCE)
            if (map != null) {
                downloadInstagramImageOrVideodata(urlwithoutlettersqp, "ds_user_id=" + map.get(SharedPrefsForInstagram.PREFERENCE_USERID)                         + "; sessionid=" + map.get(SharedPrefsForInstagram.PREFERENCE_SESSIONID))
        ...
        AndroidNetworking.get(URL)
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject) {
                        ...
                        try {
                            val listType: Type = object : TypeToken<ModelInstagramResponse?>() {}.type
...
//    }
    ...
    fun clearFB(){
        ...
        if (logedin != null && logedin != "") {
            ...
            myView.linlayout_fb_stories?.visibility = View.GONE

            if (logedin.equals("true") && logedin != ""
            ) {
                myView.chkdownload_fbstories.isChecked = true
                //loadUserData()
            } else {
                myView.chkdownload_fbstories.isChecked = false
                myView.rec_user_fblist?.visibility = View.GONE
                myView.rec_stories_fblist?.visibility = View.GONE
